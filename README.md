...
| --- | --- | --- |
| 检测 GPU、显存、内存、磁盘、FFmpeg、ComfyUI 与 H3 节点 | 五个必需模型一键直达官方文件，并标注体积与存放目录 | 本机 ComfyUI、SSH 远程显卡、MiniMax H3 云 API、Seedance 2.0 API |
...
- **配置检测**：读取 CPU、内存、GPU/显存、磁盘、FFmpeg、ComfyUI 和 H3 原生节点状态。
